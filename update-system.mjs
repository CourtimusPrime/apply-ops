...
/**
 * update-system.mjs — Safe auto-updater for apply-ops
 *
...
const CANONICAL_REPO = 'https://github.com/santifer/apply-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/santifer/apply-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/santifer/apply-ops/releases/latest';
