# Geteilter Kontext -- apply-ops (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle apply-ops-Modi
     in der deutschen Variante. Bevor du apply-ops verwendest, MUSST du:
