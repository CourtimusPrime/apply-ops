...
5. **apply-ops Proof Point**: in "Zusätzliche Informationen" einbauen, falls ein solches Feld existiert
...
3. Nächsten Schritt vorschlagen: `/apply-ops contacto` für LinkedIn-Outreach an den Personalleiter / Hiring Manager
